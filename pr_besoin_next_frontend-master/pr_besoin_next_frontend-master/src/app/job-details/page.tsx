...
export const metadata: Metadata = {
  title: "Job Details ",
  description : "View detailed information about the job, including job title, description, requirements, and application instructions.",
  keywords : "job details, job description, job requirements, job application",
};
