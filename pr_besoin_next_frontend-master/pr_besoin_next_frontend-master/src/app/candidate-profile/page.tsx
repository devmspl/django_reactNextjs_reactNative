...
import CandidateProfileBreadcrumb from "../components/employee-details/profile-bredcrumb";
import FooterOne from "@/layouts/footers/footer-one";
import CandidateDetailsArea from "../components/employee-details/employee-details-area";
