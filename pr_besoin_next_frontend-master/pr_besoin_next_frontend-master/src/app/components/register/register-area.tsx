...
const RegisterArea = () => {
  const [selectRole,SetSelectRole]=useState('66474cb591b94697b50e465e')
        ...
        <div className="user-data-form">
          ...
          <div className="form-wrapper m-auto">
            <ul className="nav nav-tabs border-0 w-100 mt-30" role="tablist">
              <li className="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="true"
                  tabIndex={-1}
                  onClick={()=>SetSelectRole('66474cb591b94697b50e465e')}
                >
                  Employee
                </button>
              </li>
              <li className="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="false"
                  tabIndex={-1}
                  onClick={()=>SetSelectRole('66474cc991b94697b50e4660')}
            ...
            <div className="tab-content mt-40">
              ...
              >
                <RegisterForm selectRole={selectRole}/>
              </div>
