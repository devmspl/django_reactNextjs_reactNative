...
import ActionDropdown from "../employee/action-dropdown";
import { ICandidate } from "@/data/employee-data";
    ...
    <div className="candidate-profile-card list-layout border-0 mb-25">
      <div className="d-flex">
        <div className="cadidate-avatar online position-relative d-block me-auto ms-auto">
          <a href="/candidate-profile" className="rounded-circle">
            <Image
              src={item.img}
              alt="image"
            ...
            <div className="col-xl-3">
              <div className="position-relative">
                <h4 className="candidate-name mb-0">
                  <a href="/candidate-profile" className="tran3s">
                    {item.name}
                  </a>
                </h4>
