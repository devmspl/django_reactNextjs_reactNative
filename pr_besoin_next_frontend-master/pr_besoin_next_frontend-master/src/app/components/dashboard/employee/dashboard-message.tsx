...
import ScheduleInterviewModal from "../../common/popup/scheduler";
...
const DashboardMessage: React.FC<IProps> = ({ setIsOpenSidebar }) => {
                ...
                <div className="message-sidebar pt-20">
                  <div className="ps-3 pe-3 ps-xxl-4 pe-xxl-4">
                    ...
                    <form action="#" className="search-form mt-20 mb-20">
                      <input type="text" placeholder="Searchcontacts" />
                      <button>
                        <Image
                          src={icon_7}
                          alt="icon"
                    ...
                    >
                      ...
                      <button className="filter_btn">
                        <span style={{ background: "#3BDA84" }}></span> Unread
                      </button>
                      <button className="filter_btn">
                    ...
                    <div className="email-info">
                      ...
                      <div className="d-flex align-items-center justify-content-end">
                        ...
                        {showModal && (
                         ...
                         isOpen={showModal}
                         closeModal={closeScheduleInterviewModal}
                         startTime={new Date().toISOString()}
                         endTime={new Date().toISOString()}
                         timeZone={{ timeZoneName: timeZone }} // Wrap timeZone in an object
                         onDayToggle={() => {}}  // Dummy function
                         onDayDelete={() => {}}   // Dummy function
                         onDayAdd={() => {}}      // Dummy function
                         onTimeZoneChange={() => {}} // Dummy function
                         onStartTimeChange={() => {}} // Dummy function
                         onEndTimeChange={() => {}} // Dummy function
                       />
                        )}
                        <button className="delete-email">
                          <Image src={icon_8} alt="icon" className="lazy-img" />
                        </button>
                        <button className="reply-email ms-3 me-3">
                          <Image src={icon_9} alt="icon" className="lazy-img" />
                        </button>
                        <div className="action-dots float-end">
                          <button
                            className="action-btn dropdown-toggle"
