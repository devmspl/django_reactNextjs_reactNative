...
import candidate_data from "@/data/employee-data";
import CandidateGridItem from "./employee-grid-item";
import CandidateListItem from "./employee-list-item";
import CandidateV1FilterArea from "./filter/employee-v1-filter-area";
