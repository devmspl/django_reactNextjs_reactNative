            ...
            <div className="right-side">
              <div className="row gx-1 align-items-center">
                ...
                <div className="col-xl-3 col-md-4 order-xl-4">
                  ...
                  <a href="/employer/messages" className="save-btn text-center rounded-circle tran3s"><i className="bi bi-chat-square-dots"></i></a>
                    <a href="#" className="save-btn text-center rounded-circle tran3s mx-1"><i className="bi bi-bookmark-dash"></i></a>
                    <a href="#" className="save-btn text-center rounded-circle tran3s"><i className="bi bi-file-x"></i></a>
                    <a href="#" className="cv-download-btn fw-300 tran3s ms-md-2 sm-mt-20">Download CV</a>
                  </div>
                </div>
              </div>
            </div>
