...
import man_1 from "@/assets/image banner/Frame 2.png";
import girl from "@/assets/image banner/Frame 4.png";
import man_2 from "@/assets/image banner/Frame 5.png";
import screen_1 from "@/assets/image banner/Frame 3.png";
import screen_2 from "@/assets/image banner/Frame 6.png";
import screen_3 from "@/assets/image banner/Frame 30.png";
          ...
          <div className="col-lg-5 order-lg-last">
            <div className="ps-xxl-4 wow fadeInRight">
              <div className="title-one">
                <h2>Get over 50.000+ talented experts in Besoin.</h2>
              </div>
