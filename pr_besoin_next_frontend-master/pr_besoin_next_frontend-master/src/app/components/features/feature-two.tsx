...
import media_1 from "@/assets/image banner/Frame 13.png";
import media_2 from "@/assets/image banner/Frame 14.png";
import media_3 from "@/assets/image banner/Frame 17.png";
import media_4 from "@/assets/image banner/Frame 16.png";
import media_5 from "@/assets/image banner/Frame 15.png";
          ...
          <div className="col-lg-7 order-lg-first">
            <div className="big-circle rounded-circle position-relative d-flex align-items-center justify-content-center ms-lg-5 wow fadeInLeft">
              <div className="inner-circle rounded-circle d-flex align-items-center justify-content-center">
                <Image src={logo} alt="logo" height={40} width={150} className="lazy-img" />
              </div>
              {/*  /.inner-circle  */}
