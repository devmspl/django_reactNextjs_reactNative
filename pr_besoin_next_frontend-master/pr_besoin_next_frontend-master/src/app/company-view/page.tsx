...
export const metadata: Metadata = {
  title: "Company view",
  description: "View detailed information about the company, including its profile, services, products, and contact information.",
  keywords : "company view, company details, company profile, company information",
