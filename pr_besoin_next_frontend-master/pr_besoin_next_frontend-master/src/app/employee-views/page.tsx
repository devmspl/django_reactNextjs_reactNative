...
export const metadata: Metadata = {
  ...
  description:"Discover how our platform can help you find qualified candidates for your job openings.",
  keywords:"employer, hiring, job postings, talent acquisition",
};
